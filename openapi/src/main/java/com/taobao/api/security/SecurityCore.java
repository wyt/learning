...
public class SecurityCore implements SecurityConstants {
    ...
    private static final AtomicBoolean initThreadPoolAtomic = new AtomicBoolean(false);
    ...
    public SecurityCore(TaobaoClient taobaoClient, String randomNum, int corePoolSize, int maxPoolSize, int maxQueue) {
