...
/**
 * TOP API: taobao.wlb.wms.sku.update response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class WlbWmsSkuUpdateResponse extends TaobaoResponse {

	private static final long serialVersionUID = 6789113121434765411L;
