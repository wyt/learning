...
/**
 * TOP API: taobao.wlb.wms.item.combination.delete response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class WlbWmsItemCombinationDeleteResponse extends TaobaoResponse {

	private static final long serialVersionUID = 8325155956724754767L;
