...
public class Item extends TaobaoObject {
	...
	private static final long serialVersionUID = 8373144275334269493L;
	...
	public MsPayment getMsPayment() {
		return this.msPayment;
	}
	public void setMsPayment(MsPayment msPayment) {
